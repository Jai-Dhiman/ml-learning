        ...
        try:
            ...
            if metadata_files:
                ...
                metadata = ModelMetadata(
                    ...
                    performance_metrics={},
                    training_steps=0,
                    vocabulary_size=config.get('model', {}).get('vocab_size', 32000) if config else 32000,
                    safety_categories=self.safety_categories
                )
            
            logger.info(f"Loaded checkpoint with {count_parameters(params):,} parameters")
...
def validate_model_config(config: Dict[str, Any]) -> bool:
    ...
    required_fields = [
        ...
        'feedforward_dim', 'max_sequence_length', 'num_classes'
    ]
